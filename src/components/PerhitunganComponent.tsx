...
const Home: React.FC = () => {
  ...
  const calculateCalories = async () => {
    ...
    try {
      ...
      toast.success('data berhasil di hitung');
      setNutrition(data);
          ...
          <div className='flex flex-col space-y-4'>
            ...
            <Tabs.Item title='Rangkuman' tabIndex={0}>
              <div className='mx-auto space-y-8 rounded-md border border-gray-200 px-5 pb-6 xl:w-10/12'>
                <div className='grid w-full place-items-center gap-x-3 gap-y-2 border-b p-4 px-5 lg:grid-cols-3'>
                  <h2>
                ...
                <div className='w-full rounded-md border border-b-0'>
                  <select className='mb-4 w-full rounded-md border p-2' value={mealsPerDay} onChange={(e) => setMealsPerDay(parseInt(e.target.value))}>
                    <option value={3}>Pilih Berapa Kali Makan Dalam Sehari</option>
